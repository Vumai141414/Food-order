...
public class FoodDetailActivity extends BaseActivity {
    ...
    private void setDataFoodDetail() {
        ...
        if (mFood.getSale() <= 0) {
            ...
            String strPrice = StringUtil.toVND(mFood.getPrice()) + Constant.CURRENCY;
            ...
            String strPriceOld = StringUtil.toVND(mFood.getPrice()) + Constant.CURRENCY;
            ...
            String strRealPrice = StringUtil.toVND(mFood.getRealPrice()) + Constant.CURRENCY;
    ...
    public void onClickAddToCart() {
        ...
        String strTotalPrice = StringUtil.toVND(totalPrice) + Constant.CURRENCY;
        ...
        tvSubtractCount.setOnClickListener(v -> {
            ...
            String strTotalPrice1 = StringUtil.toVND(totalPrice1) + Constant.CURRENCY;
        ...
        tvAddCount.setOnClickListener(v -> {
            ...
            String strTotalPrice2 = StringUtil.toVND(totalPrice2) + Constant.CURRENCY;
        ...
        tvAddCart.setOnClickListener(v -> {
            ...
            int listFoodCart = FoodDatabase.getInstance(FoodDetailActivity.this).foodDAO().getListFoodCart().size();
            Log.i("HEHE", "onClickAddToCart:" + listFoodCart);
            mActivityFoodDetailBinding.toolbar.tvCart.setText(""+listFoodCart);
