...
public class AdminFoodAdapter extends RecyclerView.Adapter<AdminFoodAdapter.AdminFoodViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AdminFoodViewHolder holder, int position) {
        ...
        if (food.getSale() <= 0) {
            ...
            String strPrice = StringUtil.toVND(food.getPrice()) + Constant.CURRENCY;
            ...
            String strOldPrice = StringUtil.toVND(food.getPrice()) + Constant.CURRENCY;
            ...
            String strRealPrice = StringUtil.toVND(food.getRealPrice()) + Constant.CURRENCY;
